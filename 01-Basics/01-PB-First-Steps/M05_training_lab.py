...
# Напишете програма, която въвежда размери на учебната зала и изчислява броя работни места в нея при описаното
...
desks_per_row = h_cm // 70
rows_number = w_cm // 120

sits_number = desks_per_row * rows_number - 3
