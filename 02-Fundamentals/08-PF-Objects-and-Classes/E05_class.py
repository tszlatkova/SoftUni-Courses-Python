...
# 2 empty lists - students and grades. Create a class attribute __students_count equal to 22. The class should also
# have 3 additional methods:
...
print(isinstance(a_class.get_average_grade(), float))
