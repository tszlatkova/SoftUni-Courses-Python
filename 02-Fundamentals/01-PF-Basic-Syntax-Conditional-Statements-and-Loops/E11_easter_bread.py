...
price_per_bread = flour_kg_price + egg_pack_price + 0.25 * milk_l_price
...
while budget >= price_per_bread:
    ...
    if loaves_bread % 3 == 0:
        colored_eggs -= (loaves_bread - 2)

    budget -= price_per_bread

print(f'You made {loaves_bread} loaves of Easter bread! Now you have {colored_eggs} eggs and {budget:.2f}BGN left.')