# Create a class called Integer. Upon initialization, it should receive a single parameter
# value (int). It should have 3 additional methods:
...
# •	from_roman(value) - creates a new instance by converting the roman number (as string)
# to an integer
    ...
    def from_roman(cls, value: str):
        ...
        for i in range(len(value)):
            if value[i] in roman_numerals:
                if i + 1 < len(value) and roman_numerals[value[i]] < \
