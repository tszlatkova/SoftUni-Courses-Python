# Create a class named Music that receives title (string), artist (string), and lyrics
# (string) upon initialization. The class should also have two additional methods:
