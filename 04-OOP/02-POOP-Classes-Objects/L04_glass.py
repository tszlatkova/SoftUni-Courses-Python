...
# You must create an instance attribute called content which should be equal to 0. You
# should also create a class attribute called capacity which should be 250 ml. Create 3
# instance methods:
