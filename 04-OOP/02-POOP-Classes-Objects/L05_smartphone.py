...
# and is_on (False by default). Create 3 methods:

# -	power() - sets is_on to True if the phone is off, otherwise sets it to False

# -	install(app, app_memory)
# o	If there is enough memory on the phone and it is on, install the app (add it to apps
# and decrease the memory of the phone) and return "Installing {app}"
# o	If there is enough memory, but the phone is off, returns "Turn on your phone to
# install {app}"
