# Create a class called Mammal. Upon initialization, it should receive a name, a type,
# and a sound. Create a class attribute called kingdom which should not be accessed
# outside the class and set it to "animals". Create three more instance methods:
