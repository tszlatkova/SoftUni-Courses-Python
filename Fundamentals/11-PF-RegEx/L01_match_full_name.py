...
# 6.	To prevent capturing of letters across new lines, put "\b" at the beginning and at the end of your regex. This
# will ensure that what precedes and what follows the match is a word boundary (like a new line).
...
valid_names = re.findall(pattern, names_to_check)
